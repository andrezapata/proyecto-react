...
const ProfesorCard = ({ nombre, especialidad, onEliminar, onEditar }) => {
  return (
      ...
      <div className="card border-0 shadow-lg rounded-4 overflow-hidden h-100" style={{ transition: "0.3s", cursor: "pointer" }}>
        <div className="text-center pt-4">
          <img src="https://cdn-icons-png.flaticon.com/512/3135/3135768.png"
            alt="Profesor" width="100" height="100"
            className="rounded-circle border border-3 border-success shadow" />
        </div>
        <div className="card-body text-center">
          <h4 className="fw-bold text-success mb-1">{nombre}</h4>
          <p className="text-muted mb-3">{especialidad}</p>
